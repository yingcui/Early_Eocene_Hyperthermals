...
################################################################
2019/01/02 -- README.txt file creation
################################################################

Provided is the code used to create the model experiments presented in the Early Eocene paper.
...
The initial, 1st-stage closed system spin-up (this is following Gutjahr et al. 2017 Nature):

./runmuffin.sh cgenie.eb_go_gs_ac_bg_sg_rg.p0055c.BASES MS/gutjahretal.2017 SPIN1 20000

(1b) Second Stage SPINUP (this is also following Gutjahr et al. 2017 Nature)
